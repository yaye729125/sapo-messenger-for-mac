...
NEW_ARCHIVE_PATHNAME="../${BUILDS_DIR}/${NEW_ARCHIVE_FILENAME}"

if [ "$REVISION" -a ! -f "$NEW_ARCHIVE_PATHNAME" ]; then
...
svn log --xml -r ${OLDEST_AVAIL_REVISION}:${REVISION} "../$SRC_DIR" > "$SNIPPET_XML_FILENAME"
