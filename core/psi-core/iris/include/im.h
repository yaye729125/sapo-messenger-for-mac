...
namespace XMPP
{
	...
	public:
		...
		void addRosterSubsyncAllowedDomain(const QString &domain);
		void clearRosterSubsyncAllowedDomainsSet();
		const QSet<QString> & rosterSubsyncAllowedDomainsSet();
