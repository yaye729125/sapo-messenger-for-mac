...
- (NSAttributedString *)labelForValue:(unsigned)value size:(unsigned)size
{
	...
	if(abs(value) < 100000)
		label = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%i",value]
												attributes:attributes];
	else
		label = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%C", 0x221e] // Infinity symbol
												attributes:attributes];
