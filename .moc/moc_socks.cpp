...
**
** Created: Thu Jul 20 17:53:25 2006
**      by: The Qt Meta Object Compiler version 59 (Qt 4.1.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../src/ambrosia/cutestuff/network/socks.h"
...
static const char qt_meta_stringdata_SocksUDP[] = {
    "SocksUDP\0\0data\0packetReady(QByteArray)\0sn_activated(int)\0"
};
...
int SocksUDP::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: sn_activated(*reinterpret_cast< int(*)>(_a[1])); break;
        }
        _id -= 2;
    }
    return _id;
...
static const char qt_meta_stringdata_SocksClient[] = {
    "SocksClient\0\0connected()\0incomingMethods(int)\0user,pass\0"
    "incomingAuth(QString,QString)\0host,port\0"
    "incomingConnectRequest(QString,int)\0incomingUDPAssociateRequest()\0"
    "sock_connected()\0sock_connectionClosed()\0sock_delayedCloseFinished()\0"
    "sock_readyRead()\0sock_bytesWritten(int)\0sock_error(int)\0serve()\0"
};
...
static const char qt_meta_stringdata_SocksServer[] = {
    "SocksServer\0\0incomingReady()\0host,port,addr,sourcePort,data\0"
    "incomingUDP(QString,int,QHostAddress,int,QByteArray)\0"
    "connectionReady(int)\0connectionError()\0sn_activated(int)\0"
};
...
int SocksServer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: sn_activated(*reinterpret_cast< int(*)>(_a[1])); break;
        }
        _id -= 5;
    }
    return _id;
