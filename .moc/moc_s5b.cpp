...
**
** Created: Thu Jul 20 17:53:41 2006
**      by: The Qt Meta Object Compiler version 59 (Qt 4.1.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../src/ambrosia/iris/jabber/s5b.h"
...
static const char qt_meta_stringdata_XMPP__S5BConnection[] = {
    "XMPP::S5BConnection\0\0proxyQuery()\0b\0proxyResult(bool)\0requesting()\0"
    "accepted()\0hosts\0tryingHosts(StreamHostList)\0proxyConnect()\0"
    "waitingForActivation()\0connected()\0datagramReady()\0doPending()\0"
    "sc_connectionClosed()\0sc_delayedCloseFinished()\0sc_readyRead()\0"
    "sc_bytesWritten(int)\0sc_error(int)\0buf\0su_packetReady(QByteArray)\0"
};
...
static const char qt_meta_stringdata_XMPP__S5BManager[] = {
    "XMPP::S5BManager\0\0incomingReady()\0req\0ps_incoming(S5BRequest)\0"
    "from,dstaddr\0ps_incomingUDPSuccess(Jid,QString)\0from,sid,streamHost\0"
    "ps_incomingActivate(Jid,QString,Jid)\0item_accepted()\0list\0"
    "item_tryingHosts(StreamHostList)\0item_proxyConnect()\0"
    "item_waitingForActivation()\0item_connected()\0item_error(int)\0"
    "query_finished()\0"
};
...
static const char qt_meta_stringdata_XMPP__S5BConnector[] = {
    "XMPP::S5BConnector\0\0result(bool)\0item_result(bool)\0t_timeout()\0"
};
...
static const char qt_meta_stringdata_XMPP__S5BServer[] = {
    "XMPP::S5BServer\0\0ss_incomingReady()\0host,port,addr,sourcePort,data\0"
...
static const char qt_meta_stringdata_XMPP__JT_PushS5B[] = {
    "XMPP::JT_PushS5B\0\0req\0incoming(S5BRequest)\0from,dstaddr\0"
    "incomingUDPSuccess(Jid,QString)\0from,sid,streamHost\0"
